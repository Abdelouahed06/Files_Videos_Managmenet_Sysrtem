class TeacherFiles extends Main {
    ...
    getFileClasses(fileId) {
        $.ajax({
            type: 'GET',
            url: this.url,
            data: {action_num: 11, file_id: fileId},
            success: (response) => {
...
var teacherFiles = new TeacherFiles('teacher_files.php', '#teacher-files tbody')
